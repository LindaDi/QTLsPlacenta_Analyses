########################################################################
## Title: This Script runs BootstrapQTL - eQTMs - for common samples and probes in CVS-Placenta & standardized variables
## Date: 01/23
...
output_file_name_cis = "02_Data/MatrixEQTL_Output/scaled_eqtm_placenta_cis_cp_samples_and_probes.txt"
...
scaled_bme_eqtm_placenta_cp_samples_probes <- BootstrapQTL(
  snps = meth, 
  gene = gene, 
  cvrt = cvrt,
  snpspos = cpgpos, 
...
save(scaled_bme_eqtm_placenta_cp_samples_probes, file = "02_Data/MatrixEQTL_Output/scaled_bme_eqtm_placenta_cp_samples_probes.Rdata")


## Section: delete placenta objects not needed anymore
########################################################################
rm(meth, gene, cvrt, cpgpos, genepos, scaled_bme_eqtm_placenta_cp_samples_probes)
...
output_file_name_cis = "scaled_eqtm_cvs_cis_cp_samples_probes.txt"
...
########################################################################
# Run the BootstrapQTL analysis
scaled_bme_eqtm_cvs_cp_samples_probes <- BootstrapQTL(
  snps = meth, 
  gene = gene, 
  cvrt = cvrt,
  snpspos = cpgpos, 
...
#save(scaled_bme_eqtm_cvs_cp_samples_probes, file = "02_Data/MatrixEQTL_Output/scaled_bme_eqtm_cvs_cp_samples_probes.Rdata")
