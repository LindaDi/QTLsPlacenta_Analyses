########################################################################
## Title: This Script runs Matrix EQTL - Basic Analyses for Cluster - meQTLs (methylation, genotypes)
## Date: 10/12/21
...
########################################################################
SNP_file_name <-  "../02_Data/prepared/geno_t_fullqced_IDc_placenta_ordered_meqtl.txt";
methylation_file_name <- "../02_Data/prepared/methylation_M_placenta_filtered_ordered_meqtl.txt";
covariates_file_name <- "../02_Data/prepared/cov_meth_placenta_ordered_meqtl.txt";
snps_location_file_name <- "../02_Data/prepared/snplocation.txt";
cpg_location_file_name <- "../02_Data/prepared/cpg_location_placenta_meth_meqtl.txt";
...
output_file_name_cis = "../02_Data/MatrixEQTL_Output/meqtl_placenta_cis.txt"
...
save(me_meqtl_placenta, file = "../02_Data/MatrixEQTL_Output/me_meqtl_placenta.Rdata")

## Section: delete placenta objects not needed anymore
########################################################################
rm(snps, gene, cvrt, cpgpos, genepos, me_meqtl_placenta)
...
## Section: define file names and paths
########################################################################
SNP_file_name <-  "../02_Data/prepared/geno_t_fullqced_IDc_cvs_ordered_meqtl.txt";
methylation_file_name <- "../02_Data/prepared/methylation_M_cvs_filtered_ordered_meqtl.txt";
covariates_file_name <- "../02_Data/prepared/cov_meth_cvs_ordered_meqtl.txt";
snps_location_file_name <- "../02_Data/prepared/snplocation.txt";
cpg_location_file_name <- "../02_Data/prepared/cpg_location_cvs_meth_meqtl.txt";
...
output_file_name_cis = "../02_Data/MatrixEQTL_Output/meqtl_cvs_cis.txt"
...
head(me_meqtl_cvs$cis$eqtls)

save(me_meqtl_cvs, file = "../02_Data/MatrixEQTL_Output/me_meqtl_cvs.Rdata")
