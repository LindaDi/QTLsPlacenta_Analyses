########################################################################
## Title: This Script runs BootstrapQTL - eQTLs - for common samples & probes in CVS-Placenta with standardized variables
## Date: 31/01/22
...
output_file_name_cis = "02_Data/MatrixEQTL_Output/scaled_beqtl_placenta_cis_cp_samples_probes.txt"
...
scaled_bme_eqtl_placenta_cp_samples_probes <- BootstrapQTL(
  snps = snps, 
  gene = gene, 
  cvrt = cvrt,
  snpspos = snpspos, 
...
save(scaled_bme_eqtl_placenta_cp_samples_probes, file = "02_Data/MatrixEQTL_Output/scaled_bme_eqtl_placenta_cp_samples_probes.Rdata")

## Section: delete placenta objects not needed anymore
########################################################################
rm(snps, gene, cvrt, snpspos, genepos, scaled_bme_eqtl_placenta_cp_samples_probes)
...
output_file_name_cis = "02_Data/MatrixEQTL_Output/scaled_beqtl_cvs_cis_cp_samples_probes.txt"
...
########################################################################
# Run the BootstrapQTL analysis
scaled_bme_eqtl_cvs_cp_samples_probes <- BootstrapQTL(
  snps = snps, 
  gene = gene, 
  cvrt = cvrt,
  snpspos = snpspos, 
...
# save(scaled_bme_eqtl_cvs_cp_samples_probes, file = "02_Data/MatrixEQTL_Output/scaled_bme_eqtl_cvs_cp_samples_probes.Rdata")
