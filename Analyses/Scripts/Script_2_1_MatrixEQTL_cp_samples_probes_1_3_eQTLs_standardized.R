########################################################################
## Title: This Script runs Matrix EQTL - eQTLs - for common samples and probes in CVS-Placenta & standardized variables
## Date: 01/2023
...
########################################################################
SNP_file_name <- "02_Data/prepared/scaled_geno_t_fullqced_IDc_placenta_ordered_eqtl_common_cp.txt"; 
expression_file_name <- "02_Data/prepared/scaled_inv_norm_placenta_tmm_filtered_ordered_eqtl_common_cp_and_probes.txt"
covariates_file_name <- "02_Data/prepared/scaled_cov_rna_placenta_ordered_eqtl_common_cp.txt"
...
output_file_name_cis = "02_Data/MatrixEQTL_Output/scaled_eqtl_placenta_cis_cp_samples_pobes.txt"
...
########################################################################
scaled_me_eqtl_placenta_cp_samples_probes = Matrix_eQTL_main(
...
head(scaled_me_eqtl_placenta_cp_samples_probes$cis$eqtls)

save(scaled_me_eqtl_placenta_cp_samples_probes, file = "02_Data/MatrixEQTL_Output/scaled_me_eqtl_placenta_cp_samples_probes.Rdata")

## Section: delete placenta objects not needed anymore
########################################################################
rm(snps, gene, cvrt, snpspos, genepos, scaled_me_eqtl_placenta_cp_samples_probes)
...
## Section: define file names and paths
########################################################################
SNP_file_name <- "02_Data/prepared/scaled_geno_t_fullqced_IDc_cvs_ordered_eqtl_common_cp.txt"
expression_file_name <- "02_Data/prepared/scaled_inv_norm_cvs_tmm_filtered_ordered_eqtl_common_cp_and_probes.txt"
covariates_file_name <- "02_Data/prepared/scaled_cov_rna_cvs_ordered_eqtl_common_cp.txt"
...
output_file_name_cis = "02_Data/MatrixEQTL_Output/scaled_eqtl_cvs_cis_cp_samples_probes.txt"
...
## Section: run analysis
########################################################################
scaled_me_eqtl_cvs_cp_samples_probes = Matrix_eQTL_main(
  snps = snps, # SlicedData object with genotype information.
  gene = gene, # SlicedData object with gene expression information.
  cvrt = cvrt, # SlicedData object with additional covariates.
  snpspos = snpspos, # must have 3 columns - SNP name, chromosome, and position
...
head(scaled_me_eqtl_cvs_cp_samples_probes$cis$eqtls)

save(scaled_me_eqtl_cvs_cp_samples_probes, file = "02_Data/MatrixEQTL_Output/scaled_me_eqtl_cvs_cp_samples_probes.Rdata")
