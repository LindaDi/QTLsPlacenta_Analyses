########################################################################
## Title: This Script runs BootstrapQTL - for Cluster - meQTLs (methylation, genotypes)
## Date: 14/01/22
...
output_file_name_cis = "meqtl_placenta_cis.txt"
...
bme_meqtl_placenta <- BootstrapQTL(
  snps = snps,
  gene = gene,
  cvrt = cvrt,
  snpspos = snpspos,
  genepos = cpgpos,
  n_bootstraps=200, n_cores=20, # default 200 bootstraps
...
save(bme_meqtl_placenta, file = "../02_Data/MatrixEQTL_Output/bme_meqtl_placenta.Rdata")

## Section: delete placenta objects not needed anymore
########################################################################
rm(snps, gene, cvrt, snpspos, cpgpos, bme_meqtl_placenta)
...
output_file_name_cis = "meqtl_cvs_cis.txt"
...
save(bme_meqtl_cvs, file = "../02_Data/MatrixEQTL_Output/bme_meqtl_cvs.Rdata")
